...
class DataGenerator:
    ...
    def gen_thread_target(self, _L):
        ...
        #self.database.print_sample(1) #in case you want to print a specific row from the database
        
        #If want to print a certain sample, uncomment the following lines:
        #record1,samp1 = self.database.print_first_row()
        #print("record:", record1, "sample:", samp1, "\n")
        #record2,samp5 = self.database.print_sample(5)
        #print("record:", record2, "sample:", samp5, "\n")
