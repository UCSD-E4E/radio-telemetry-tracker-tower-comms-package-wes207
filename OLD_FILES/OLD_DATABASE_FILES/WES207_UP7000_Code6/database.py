...
class TowerDatabase:
    ...
    def __init__(self, db_name =towerConfig.DB_Name):
        ...
        self.sample_counter = self.get_next_sample_num() #entry number for this newly generated data
    ...
    def print_row(self,print_row):
        ...
        con.close()
        #convert record to string for sending.
    ...
    #9/10 Save and Load most recent Sample Number in json file to persist between power cycling and database emptying.
