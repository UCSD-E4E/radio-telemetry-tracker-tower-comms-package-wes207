...
port = 'COM4'                       # Serial port (windows), use device manager to change port to COMXX
#port = '/dev/tty.usbserial-2'     # Inital serial port for mac
...
def main():
    ...
    try:
        ...
        process = subprocess.Popen(
            #UPON SETUP, PICK THE CORRECT OS and update the DIRECTORY BELOW.
            #["python3", "/home/will/Desktop/WES207/WES207_UP7000_Code7/runme.py"], #Ubuntu
            ["python", "C:/Users/chatw/Desktop/WES_MAS_Grad_School/9_WES207_Capstone/WES207_UP7000_Code7/runme.py"],
            #["python3", "/Users/williamgong/Desktop/WES/Final_project/data_code/runme.py"], #MAC
